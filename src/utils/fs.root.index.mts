 ...
 */
export default function generateRootIndexFile(rootFolderPath: string, serviceVarName: string, serviceFolderName: string) {
...
const initFileTemplate = (varName: string) => `
